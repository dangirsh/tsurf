...
echo "    ./scripts/deploy.sh --node ovh --first-deploy"
echo ""
echo "  WARNING: Do NOT run ./scripts/deploy.sh --node ovh from the"
echo "  PUBLIC repo (neurosys) — it will strip private services and"
echo "  lock you out. The public deploy.sh hard-refuses --node ovh."
echo ""
