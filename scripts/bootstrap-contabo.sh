...
EXTRA_FILES="$FLAKE_DIR/tmp/tsurf-host-keys"
FLAKE_TARGET="${FLAKE_TARGET:?ERROR: Set FLAKE_TARGET env var to your private overlay flake target (e.g. /path/to/private-tsurf#tsurf)}"
TAILSCALE_HOSTNAME="tsurf"
