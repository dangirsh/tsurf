...
in
{
  ...
  # @decision MTX-08: app_service_config_files lists all bridge registration files.
  # @rationale: Conduit reads these at startup to validate bridge as_token/hs_token.
  #   Without this, bridges fail with "as_token not accepted" on every start.
  #   Files are generated by each bridge on first launch and persist in their state dirs.
