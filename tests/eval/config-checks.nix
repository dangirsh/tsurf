...
in
{
  ...
  template-mode-tsurf = mkCheck
    "template-mode-tsurf"
    "tsurf host has allowUnsafePlaceholders = true (template mode)"
    "tsurf host missing allowUnsafePlaceholders — public template won't evaluate"
